...
#curl --header "PRIVATE-TOKEN: pHNJ8ksUCCssCDmtyZxh" --data-urlencode "name=ezsrepo4" --data-urlencode "namespace_id=10" "https://$EZSLAB_GITLAB_SERVER/api/v3/projects"
#curl --request POST --header "PRIVATE-TOKEN: pHNJ8ksUCCssCDmtyZxh" https://$EZSLAB_GITLAB_SERVER/api/v3/projects/:id/members/:user_id?access_level=30
